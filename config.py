...
# 42 in test.py
    if mode == 'train':
        ...
        notrain = False
        snapshot = './runs/PANet_VOC_sets_0_1way_5shot_[train]/4/snapshots/30000.pth'
        n_runs = 5
        n_steps = 1000
        batch_size = 1
        scribble_dilation = 0
    ...
    path = {
        ...
        'VOC':{'data_dir': '/home/gokul/Documents/Btech_Hons/PANet/data/Pascal/VOCdevkit/VOC2012/',
               'data_split': 'trainaug',},
